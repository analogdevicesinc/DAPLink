...
struct _mxc_spi_req_t {
    ...
    int ssIdx;                  ///< Target Select (TS) Index for this request
    int ssDeassert;             ///< Deassert Target Select (TS) line at end of transaction.
    uint8_t *txData;
    uint8_t *rxData;
    ...
    mxc_spi_callback_t completeCB; ///< Callback at the end of transaction
...
//////>>> Previous Implementation (SPI v1)
/**
